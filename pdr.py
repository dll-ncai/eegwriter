...
class PDREstimator:
    ...
    def fit(self, data):
        ...
        # Channel Rejection (RMS based)
        valid_indices, clean_data = self._channel_rejection(data_car)

        # Check if O1/O2 survived rejection
        # We need to map original O1/O2 indices to new clean indices
        ...
        # Spectral Estimation & Peak Detection
    ...
    def _channel_rejection(self, data):
        """
        Rejects bad channels based on RMS thresholds
        """
